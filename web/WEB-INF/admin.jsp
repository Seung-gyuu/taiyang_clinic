...
<body>
    ...
    <!--    <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-3 text-dark" style="background-color: #f3f2f2;">
    ...
    <div class="container-fluid py-5">
        <div class="container">
            <div class="text-center font-weight-bold mx-auto mb-5" style="max-width: 500px;">
                <h2 class="display-5 text-center mt-3">Welcome to Admin Page</h2>
            </div>
            <div class="row g-5">
                <div class="col-lg-4 col-md-6">
                    <div class="service-item rounded d-flex flex-column align-items-center justify-content-center text-center my-4" style="background-color: #f3f2f2; padding: 20px;">
                        <div class="service-icon mb-4">
                            <i class="fa fa-2x fa-user text-black"></i>
                        </div>
                        <h4 class="mb-3">Users</h4>
                        <a class="btn btn-lg rounded-pill px-7 py-2" style ="background-color: #198754" href="/ausers">
                            <i class="bi bi-arrow-right arrow-icon" style="color: #FFFFFF; font-weight: bold;"></i>
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="service-item rounded d-flex flex-column align-items-center justify-content-center text-center my-4" style="background-color: #f3f2f2; padding: 20px;">
                        <div class="service-icon mb-4">
                            <i class="fa fa-2x fa-window-maximize text-black"></i>
                        </div>
                        <h4 class="mb-3">Availability</h4>
                        <a class="btn btn-lg rounded-pill px-7 py-2" style ="background-color: #198754" href="/aavailability">
                            <i class="bi bi-arrow-right arrow-icon" style="color: #FFFFFF; font-weight: bold;" ></i>
                        </a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="service-item rounded d-flex flex-column align-items-center justify-content-center text-center my-4" style="background-color: #f3f2f2; padding: 20px;">
                        <div class="service-icon mb-4">
                            <i class="fa fa-2x fa-file text-black"></i>
                        </div>
                        <h4 class="mb-3">Add consent/Medical form</h4>
                        <a class="btn btn-lg rounded-pill px-7 py-2" style ="background-color: #198754" href="">
                            <i class="bi bi-arrow-right arrow-icon" style="color: #FFFFFF; font-weight: bold;" ></i>
                        </a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="service-item rounded d-flex flex-column align-items-center justify-content-center text-center my-4" style="background-color: #f3f2f2; padding: 20px;">
                        <div class="service-icon mb-4">
                            <i class="fa fa-2x fa-sticky-note text-black"></i>
                        </div>
                        <h4 class="mb-3">View forms</h4>
                        <a class="btn btn-lg rounded-pill px-7 py-2" style ="background-color: #198754" href="">
                            <i class="bi bi-arrow-right arrow-icon" style="color: #FFFFFF; font-weight: bold;" ></i>
                        </a>
                    </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="service-item rounded d-flex flex-column align-items-center justify-content-center text-center my-4" style="background-color: #f3f2f2; padding: 20px;">
                        <div class="service-icon mb-4">
                            <i class="fa fa-2x fa-laptop text-black"></i>
                        </div>
                        <h4 class="mb-3">View appointment</h4>
                        <a class="btn btn-lg rounded-pill px-7 py-2" style ="background-color: #198754" href="">
                            <i class="bi bi-arrow-right arrow-icon" style="color: #FFFFFF; font-weight: bold;" ></i>
                        </a>
                    </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="service-item rounded d-flex flex-column align-items-center justify-content-center text-center my-4" style="background-color: #f3f2f2; padding: 20px;">
                        <div class="service-icon mb-4">
                            <i class="fa fa-2x fa-check-square text-black"></i>
                        </div>
