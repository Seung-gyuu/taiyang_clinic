...
<![endif]-->
  ...
  <![endif]-->
    ...
    <tbody>
      <tr>
        <td style="padding:20px 15px 15px 15px; line-height:26px; text-align:inherit; background-color:#d488cc;" height="100%" valign="top" bgcolor="#d488cc" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="font-family: helvetica, sans-serif; color: #932a89; font-size: 24px"><strong>T A I Y A N G C L I N I C</strong></span></div><div></div></div></td>
      </tr>
    </tbody>
    ...
    <tbody>
      <tr>
        <td style="padding:40px 0px 30px 0px; line-height:36px; text-align:inherit; background-color:#74bcd9;" height="100%" valign="top" bgcolor="#74bcd9" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="font-size: 36px; color: #ffffff; font-family: helvetica, sans-serif"><strong>Appointment Reminder</strong></span></div><div></div></div></td>
      </tr>
    </tbody>
    ...
    <tbody>
      <tr>
        <td style="padding:50px 30px 30px 30px; line-height:28px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content"><div><div style="font-family: inherit; text-align: inherit"><span style="font-size: 20px; font-family:  helvetica, sans-serif; color: #656565">Hello, {{name}}</span></div>
<div style="font-family: inherit; text-align: inherit"><br></div>
<div style="font-family: inherit; text-align: inherit">
<span style="font-size: 20px; font-family:  helvetica, sans-serif; color: #656565">We wanted to remind you about your upcoming appointment. </span>
<span style="font-size: 20px; font-family:  helvetica, sans-serif; color: #932a89"><strong>
<br>
<br
>DATE: {{appointmentDate}} <br>
TIME: {{startTime}} - {{endTime}}<br>
SERVICE: {{service}}</strong></span> <br>
<br>
<span style="font-size: 20px; font-family: helvetica, sans-serif; color: #656565">How to Prepare for an Acupuncture Appointment</span>
<br>
<br>
...
5. Avoid Caffeine Before Your Appointment.
    ...
    <tbody>
      <tr>
        <td style="padding:40px 100px 50px 30px; line-height:26px; text-align:inherit; background-color:#FFFFFF;" height="100%" valign="top" bgcolor="#FFFFFF" role="module-content"><div><div style="font-family: inherit; text-align: inherit"><span style="font-family: helvetica, sans-serif; font-size: 16px; color: #656565">Best Regards,</span></div>
<div style="font-family: inherit; text-align: inherit"><span style="font-family: helvetica, sans-serif; font-size: 16px; color: #656565">TaiYang clinic </span></div><div></div></div></td>
      </tr>
    </tbody>
  </table></td>
        </tr>
