...
<link href="https://fonts.googleapis.com/css2?family=Viga&display=swap" rel="stylesheet"><style>
  ...
  <table class="module" role="module" data-type="text" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;" data-muid="1995753e-0c64-4075-b4ad-321980b82dfe" data-mc-module-version="2019-10-22">
    <tbody>
      <tr>
        <td style="padding:100px 0px 18px 0px; line-height:36px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><div style="font-family: inherit; text-align: inherit"><span style="color: #ffffff; font-size: 40px; font-family: inherit">Thank you for your booking</span></div><div></div></div></td>
      </tr>
    </tbody>
    ...
    <tbody>
      <tr>
        <td style="padding:18px 20px 20px 0px; line-height:24px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><div style="font-family: inherit; text-align: inherit"><span style="font-size: 24px">Hello, {{name}}</span></div>
<div style="font-family: inherit; text-align: inherit"><span style="font-size: 24px">Your appointment is confirmed. See below for the full details. </span></div><div></div></div></td>
      </tr>
    </tbody>
    ...
    <tbody>
      <tr>
        <td style="padding:30px 20px 18px 30px; line-height:22px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><div style="font-family: inherit; text-align: inherit"><span style="color: #0055ff; font-size: 24px">Booking Details</span></div><div></div></div></td>
      </tr>
    </tbody>
    ...
    <tbody>
      <tr>
        <td style="padding:18px 20px 18px 30px; line-height:22px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div>
<div style="font-family: inherit; text-align: inherit"><br></div>
<div style="font-family: inherit; text-align: inherit ; font-size: 23px; line-height: 28px">DATE: {{appointmentDate}}</div>
<div style="font-family: inherit; text-align: inherit ; font-size: 23px; line-height: 28px">TIME: {{startTime}} - {{endTime}}</div>
<div style="font-family: inherit; text-align: inherit ; font-size: 23px; line-height: 28px">SERVICE: {{service}}</div>
<br>
<div><span style="color: #0055ff; font-size: 20px">How to Prepare for an Acupuncture Appointment</span>
<br>
<span style="font-size: 16px; line-height:35px">1. Set Aside Time Before and After Your Appointment.  
<br>
...
<br>
5. Avoid Caffeine Before Your Appointment. </span> </div>
<br>
<div>
<span style="color: #0055ff; font-size: 20px">Cancellation Policy </span><br>
<span style="font-size: 16px">We have a 24 hour cancellation policy.
If you need to cancel your appointment, we respectfully request at least 24 hour notice.
</span>
</div>
</div></td>
      </tr>
...
© TAIYANG CLINIC. All Rights Reserved.</div>
</div></td>
      </tr>
    </tbody>
  </table></td>
      ...
      <tbody>
        <tr>
          <td align="center" class="outer-td" style="padding:0px 0px 20px 0px; background-color:0055FF;">
