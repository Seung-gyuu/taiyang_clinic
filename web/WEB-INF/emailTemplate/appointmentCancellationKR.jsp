                                                                                                    ...
                                                                                                    <tbody>
                                                                                                        <tr>
                                                                                                            <td style="padding:18px 20px 18px 30px; line-height: 30px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div>
                                                                                                                    ...
                                                                                                                    <div style="font-family: inherit; text-align: inherit ; font-size: 23px; line-height: 28px"><span style="font-size: 22px">As requested, We have successfully canceled your appointment for AND THIS IS KOREAN EMAIL: </span></div>
                                                                                                                    <br>
                                                                                                                                ...
                                                                                                                                <br>
                                                                                                                                    <div style="font-family: inherit; text-align: inherit ; font-size: 15px; line-height: 28px">If you want to book new appointment, we invite you to book a new appointment by clicking on the following button: </div><br>
                                                                                                                                        <div style="text-align: center">
                                                                                                                                            <a href="http://localhost:8084/home?fromValidation=true" class="f-fallback button button--green" target="_blank">Book new appointment</a>
                                                                                                                                        </div>
                                                                                                                                        <br>
